...
CREATE TABLE `accounts` (
  ...
  `User_Role` varchar(45) COLLATE utf8_bin NOT NULL DEFAULT 'EMPLOYEE',
  PRIMARY KEY (`ID`),
...
INSERT INTO `accounts` VALUES (1,'1',_binary '','','');
...
CREATE TABLE `dm_thanhphanthuoc` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `MaThanhPhan` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `TenThanhPhan` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `thuoc_thanhphan` (
  ...
  `DinhLuong` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2019-02-19 11:40:34
