...
--
-- Table structure for table `account_benh_danhdau`
--

DROP TABLE IF EXISTS `account_benh_danhdau`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `account_benh_danhdau` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ID_Account` int(11) NOT NULL,
  `ID_Benh` int(11) NOT NULL,
  `NgayDanhDau` datetime DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `account_benh_danhdau`
--

LOCK TABLES `account_benh_danhdau` WRITE;
/*!40000 ALTER TABLE `account_benh_danhdau` DISABLE KEYS */;
INSERT INTO `account_benh_danhdau` VALUES (1,1,23,'2019-02-25 13:16:33'),(2,1,24,'2019-02-21 17:28:55');
/*!40000 ALTER TABLE `account_benh_danhdau` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `accounts` (
  ...
  `User_Role` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT 'EMPLOYEE',
  PRIMARY KEY (`ID`),
...
INSERT INTO `accounts` VALUES (1,'nhienpt',_binary '','','');
...
INSERT INTO `dm_dangbaoche` VALUES (1,'V','viên nén','gggg'),(3,'d','đ','dd'),(4,'VN_P','Viên nén bao phim','');
...
INSERT INTO `dm_nhaphanphoi` VALUES (1,'fdf','dfdf','fdf','fdfd','',_binary ''),(2,'kkk','kkk','kk','kkk','kk',_binary ''),(3,'dfd','gfg','','gfgf','',_binary '\0'),(4,'hhhh','gggg','hn','123','',_binary '\0'),(5,'PP0001','Công ty TNHH thương mại dược phẩm Phương Linh','','','',_binary '');
...
INSERT INTO `dm_nhomthuoc` VALUES (1,'N0001','Nhóm 0001',2,'gdg'),(3,'N003','Nhóm 0003',4,''),(4,'N0004','Nhóm 4',4,'grgrtyg'),(5,'VTM001','Các Vitamin và acid amin',5,'');
...
INSERT INTO `dm_phanloaithuoc` VALUES (2,'L0010','Phân loại 0001','Phân loại 0001'),(3,'L2','Phân loại 0002','ssss'),(4,'L3','Phân loại 0003','rể'),(5,'VTM','Vitamin và thuốc bổ','');
/*!40000 ALTER TABLE `dm_phanloaithuoc` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dm_thanhphanthuoc`
--

DROP TABLE IF EXISTS `dm_thanhphanthuoc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `dm_thanhphanthuoc` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `MaThanhPhan` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `TenThanhPhan` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `MoTa` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `dm_thanhphanthuoc`
--

LOCK TABLES `dm_thanhphanthuoc` WRITE;
/*!40000 ALTER TABLE `dm_thanhphanthuoc` DISABLE KEYS */;
INSERT INTO `dm_thanhphanthuoc` VALUES (1,'TP1113','TP1113',NULL),(2,'TP1112','TP1112',NULL),(4,'TP1111','TP1111',NULL);
/*!40000 ALTER TABLE `dm_thanhphanthuoc` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `dm_thuoc` VALUES (1,'t1','ttt','112123121121231211212312112123121121231211212312',1,'d',1,1,NULL,'dđ','fgf','gfg','dfgd','gdgfd',1,NULL,NULL),(2,'cvcvcx','cxvxv','xvxvx',3,'vxvcxv',2,3,NULL,'xvxv','vxvx','xvxv','xv','xvxv',1,'xvx',NULL),(3,'rr','f','f',1,'f',2,3,NULL,'f','f','f','f','f',3,'f',NULL),(4,'b','b','b',1,'b',2,3,NULL,'bb','bb','bb','bb','bb',4,'bb',NULL),(5,'c','c','c',1,'c',2,3,NULL,'c','c','c','c','c',1,'c',NULL),(6,'d','d','d',1,'d',1,1,NULL,'d','d','d','d','d',1,'d',NULL),(7,'d','d','d',1,'d',1,1,NULL,'d','d','d','d','d',1,'d',NULL),(8,'d','d','d',1,'d',1,1,NULL,'d','d','d','d','d',1,'d',NULL),(9,'d','d','d',1,'d',1,1,NULL,'d','d','d','d','d',1,'d',NULL),(10,'d','d','d',1,'d',1,1,NULL,'d','d','d','d','d',1,'d',NULL),(11,'d','d','d',1,'d',1,1,NULL,'d','d','d','d','d',1,'d',NULL),(12,'d','d','d',1,'d',1,1,NULL,'d','d','d','d','d',1,'d',NULL),(13,'d','d','d',1,'d',1,1,NULL,'d','d','d','d','d',1,'d',NULL),(14,'d','d','d',1,'d',1,1,NULL,'d','d','d','d','d',1,'d',NULL),(15,'d','d','d',1,'d',1,1,NULL,'d','d','d','d','d',1,'d',NULL),(16,'AB_E_BONE_CARE','AB Extra Bone-care','VN-2883-07',4,'Hộp 6 vỉ x 10 viên',-1,5,NULL,'Ngăn ngừa và điều trị loãng xương','Mẫn cảm với các thành phần của thuốc. Suy thận nặng, tăng nồng độ Ca trong máu và nước tiểu.','Tetracyclin . tăng hiệu quả digiyails','Tiền sử suy thận , sỏi thận','Người lớn: 1 viên x 3 lần/ngày. Phụ nữ có thai và cho con bú: 1 viên/ngày. Trẻ >2 tuổi: 1-2 viên/ngày. Trẻ 1-2 tuổi: 4 viên/ngày. Trẻ <12 tháng tuổi: không nên dùng',5,'',NULL);
...
--
-- Table structure for table `thuoc_thanhphan`
--

DROP TABLE IF EXISTS `thuoc_thanhphan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `thuoc_thanhphan` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ID_Thuoc` int(11) NOT NULL,
  `ID_ThanhPhan` int(11) NOT NULL,
  `DinhLuong` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `GhiChu` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
--
-- Dumping data for table `thuoc_thanhphan`
--

LOCK TABLES `thuoc_thanhphan` WRITE;
/*!40000 ALTER TABLE `thuoc_thanhphan` DISABLE KEYS */;
/*!40000 ALTER TABLE `thuoc_thanhphan` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-02-25 13:24:13
