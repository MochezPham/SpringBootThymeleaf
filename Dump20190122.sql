...
CREATE TABLE `dm_dangbaoche` (
  ...
  `ChiChu` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
CREATE TABLE `dm_thuoc` (
  ...
  `SDK` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DangBaoChe` int(11) DEFAULT NULL,
  `DongGoi` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CTSX` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2019-01-22 12:56:58
